...
'label'          => 'TruField In Person Workshop/Demo Day Date Held',
...
'label'         => 'TruField In Person Workshop/Demo Day (Yes or No)',
...
'label'    => 'TruField In Person Workshop/Demo Day Location',
...
'label'    => 'TruField In Person Workshop/Demo Day Number of Attendees',
...
[
'key'   => 'field_tf_phase_3_tillage_type',
'label' => 'Tillage Type',
'name'  => 'phase_3_tillage_type',
'type'  => 'text',
],
[
'key'   => 'field_tf_phase_3_soil_temp_f_at_application',
'label' => 'Soil Temp (F) at application',
'name'  => 'phase_3_soil_temp_f_at_application',
'type'  => 'number',
'min'   => 0,
'step'  => '0.1',
],
[
'key'   => 'field_tf_phase_3_carrier_volume_gal',
'label' => 'Carrier Volume (Gal)',
'name'  => 'phase_3_carrier_volume_gal',
'type'  => 'number',
'min'   => 0,
'step'  => '0.1',
],
[
'key'   => 'field_tf_phase_3_tank_mix_partners',
'label' => 'Tank Mix Partners',
'name'  => 'phase_3_tank_mix_partners',
'type'  => 'textarea',
'rows'  => 3,
],
[
'key'            => 'field_tf_phase_3_planting_date',
'label'          => 'Planting Date',
'name'           => 'phase_3_planting_date',
'type'           => 'date_picker',
'display_format' => 'm/d/Y',
'return_format'  => 'Y-m-d',
],
[
'key'   => 'field_tf_phase_3_hybrid_variety',
'label' => 'Hybrid/Variety',
'name'  => 'phase_3_hybrid_variety',
'type'  => 'text',
],
[
'key'   => 'field_tf_phase_3_planting_population',
'label' => 'Planting Population',
'name'  => 'phase_3_planting_population',
'type'  => 'number',
'min'   => 0,
],
[
'key'   => 'field_tf_phase_3_row_spacing_in',
'label' => 'Row Spacing (in)',
'name'  => 'phase_3_row_spacing_in',
'type'  => 'number',
'min'   => 0,
'step'  => '0.1',
],
[
'key'   => 'field_tf_phase_3_planting_speed_mph',
'label' => 'Planting Speed (mph)',
'name'  => 'phase_3_planting_speed_mph',
'type'  => 'number',
'min'   => 0,
'step'  => '0.1',
],
[
'key'   => 'field_tf_phase_3_plant_heights_avg_untreated_v7_in',
'label' => 'Plant Heights Avg Untreated @ V7 (In)',
'name'  => 'phase_3_plant_heights_avg_untreated_v7_in',
'type'  => 'number',
'min'   => 0,
'step'  => '0.01',
],
[
'key'   => 'field_tf_phase_3_plant_heights_avg_treated_v7_in',
'label' => 'Plant Heights Avg Treated @ V7 (In)',
'name'  => 'phase_3_plant_heights_avg_treated_v7_in',
'type'  => 'number',
'min'   => 0,
'step'  => '0.01',
],
[
'key'   => 'field_tf_phase_3_stalk_diameter_untreated_v7_mm',
'label' => 'Stalk Diameter Untreated @ V7 (mm)',
'name'  => 'phase_3_stalk_diameter_untreated_v7_mm',
'type'  => 'number',
'min'   => 0,
'step'  => '0.01',
],
[
'key'   => 'field_tf_phase_3_stalk_diameter_treated_v7_mm2',
'label' => 'Stalk Diameter Treated @ V7 (mm)2',
'name'  => 'phase_3_stalk_diameter_treated_v7_mm2',
'type'  => 'number',
'min'   => 0,
'step'  => '0.01',
],
[
'key'   => 'field_tf_phase_3_yield_untreated_bu_ac',
'label' => 'Yield Untreated (bu/ac)',
'name'  => 'phase_3_yield_untreated_bu_ac',
'type'  => 'number',
'min'   => 0,
'step'  => '0.01',
],
[
'key'   => 'field_tf_phase_3_yield_treated_bu_ac',
'label' => 'Yield Treated (bu/ac)',
'name'  => 'phase_3_yield_treated_bu_ac',
'type'  => 'number',
'min'   => 0,
'step'  => '0.01',
],
[
'key'   => 'field_tf_phase_3_moisture_untreated_percent',
'label' => 'Moisture Untreated (%)',
'name'  => 'phase_3_moisture_untreated_percent',
'type'  => 'number',
'min'   => 0,
'max'   => 100,
'step'  => '0.1',
...
[
'key'   => 'field_tf_phase_3_moisture_treated_percent',
'label' => 'Moisture Treated (%)',
'name'  => 'phase_3_moisture_treated_percent',
'type'  => 'number',
'min'   => 0,
'max'   => 100,
'step'  => '0.1',
...
[
'key'   => 'field_tf_phase_3_test_weight_untreated_lbs_bu',
'label' => 'Test Weight Untreated (lb/bu)',
'name'  => 'phase_3_test_weight_untreated_lbs_bu',
'type'  => 'number',
'min'   => 0,
'step'  => '0.01',
],
[
'key'   => 'field_tf_phase_3_test_weight_treated_lbs_bu',
'label' => 'Test Weight Treated (lb/bu)',
'name'  => 'phase_3_test_weight_treated_lbs_bu',
'type'  => 'number',
'min'   => 0,
'step'  => '0.01',
],
[
'key'           => 'field_tf_phase_3_as_applied_gis_data',
'label'         => 'As Applied GIS Data (Y/N)',
'name'          => 'phase_3_as_applied_gis_data',
'type'          => 'select',
'choices'       => [
'yes' => 'Yes',
'no'  => 'No',
...
[
'key'           => 'field_tf_phase_3_planting_gis_data',
'label'         => 'Planting GIS Data (Y/N)',
'name'          => 'phase_3_planting_gis_data',
'type'          => 'select',
'choices'       => [
'yes' => 'Yes',
'no'  => 'No',
...
[
'key'           => 'field_tf_phase_3_harvest_gis_data',
'label'         => 'Harvest GIS Data (Y/N)',
'name'          => 'phase_3_harvest_gis_data',
'type'          => 'select',
'choices'       => [
'yes' => 'Yes',
'no'  => 'No',
...
[
'key'   => 'field_tf_phase_3_agronomy_comments',
'label' => 'Agronomy Comments',
'name'  => 'phase_3_agronomy_comments',
'type'  => 'textarea',
'rows'  => 4,
],
],
