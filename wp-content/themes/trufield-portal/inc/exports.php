...
get_post_meta( $id, 'rsm_bam', true ),
get_post_meta( $id, 'fsa', true ),
...
get_post_meta( $id, 'phase_1_carrier_volume_gal', true ),
get_post_meta( $id, 'phase_1_protocol_version', true ),
trufield_get_phase_status( $id, 2 ),
$yes_no( (bool) get_post_meta( $id, 'phase_2_verified', true ) ),
$select_label( 'phase_2_application_type', (string) get_post_meta( $id, 'phase_2_application_type', true ) ),
get_post_meta( $id, 'phase_2_application_date', true ),
get_post_meta( $id, 'phase_2_verify_acres_treated', true ),
get_post_meta( $id, 'phase_2_verify_carrier_volume_gal', true ),
get_post_meta( $id, 'phase_2_soil_temp_f', true ),
get_post_meta( $id, 'phase_2_emergence', true ),
get_post_meta( $id, 'phase_2_stand_count', true ),
get_post_meta( $id, 'phase_2_plant_heights', true ),
